...
If `es.exe` is not found, download from https://github.com/voidtools/ES/releases (get the x64 zip), extract `es.exe` to a PATH location like `C:\Users\<user>\AppData\Local\Microsoft\WindowsApps\`.
